...
def install() -> None:
    ...
    print("", file=sys.stderr)
    print("If Chrome says 'host not found' after a full restart:", file=sys.stderr)
    print("  - Visit chrome://inspect/#native-messaging to see registered hosts", file=sys.stderr)
    print("  - Ensure no other Chrome profiles are running (check Task Manager)", file=sys.stderr)
